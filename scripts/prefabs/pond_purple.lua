...
local function pondpurple()
    local inst = commonfn("_purple")
    ...
    inst.components.childspawner:SetRareChild("frog_purple", 0.25)
...
return Prefab("pond_purple", pondpurple, assets, prefabs)
