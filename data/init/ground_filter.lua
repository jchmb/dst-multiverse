...
AddStandardTerrainFilter("rock_limpet")
AddRoboTerrainFilter("rock_iron")
AddStandardTerrainFilter("wildbore_house")
AddStandardTerrainFilter("rabbithouse_farmer")
AddStandardTerrainFilter("rabbithouse_snow")
AddStandardTerrainFilter("crate")
AddStandardTerrainFilter("bambootree")
AddStandardTerrainFilter("hatpighouse")
