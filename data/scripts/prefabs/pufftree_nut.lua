...
local function plant(inst, growtime)
    local sapling = SpawnPrefab("pufftree_sapling")
...
local function fn()
    ...
    inst.AnimState:SetBuild("pufftree_nut")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/pufftree_nut.xml"
