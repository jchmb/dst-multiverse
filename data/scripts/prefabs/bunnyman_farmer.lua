local assets =
{
	...
	Asset("ANIM", "anim/bunnyman_farmer_build.zip"),
...
local function fn()
	...
	inst.AnimState:SetBuild("bunnyman_farmer_build")
	...
	inst.AnimState:SetClientsideBuildOverride("insane", "bunnyman_farmer_build", "manrabbit_beard_build")
...
return Prefab("bunnyman_farmer", fn, assets, prefabs)
