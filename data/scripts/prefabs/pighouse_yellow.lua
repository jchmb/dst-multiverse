...
local assets =
{
    ...
    Asset("ANIM", "anim/pig_slimey_house.zip"),
...
local function MakeWindow()
    ...
    inst.AnimState:SetBuild("pig_slimey_house")
...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
    ...
    inst.components.spawner:Configure("pigman_yellow", TUNING.TOTAL_DAY_TIME*4)
...
return Prefab("pighouse_yellow", fn, assets, prefabs),
    MakePlacer("pighouse_yellow_placer", "pig_house", "pig_slimey_house", "idle")
