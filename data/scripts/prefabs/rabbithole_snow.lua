...
local function dig_up(inst)
    if inst.components.spawner:IsOccupied() then
        inst.components.lootdropper:SpawnLootPrefab("rabbit_snow")
    end
...
local function fn()
    ...
    inst.components.spawner:Configure("rabbit_snow", TUNING.RABBIT_RESPAWN_TIME)
...
return Prefab("rabbithole_snow", fn, assets, prefabs)
