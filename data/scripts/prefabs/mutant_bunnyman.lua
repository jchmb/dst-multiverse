local assets =
{
    ...
    Asset("ANIM", "anim/manrabbit_mutant_build.zip"),
...
local regularloot = { "monstermeat" }

local brain = require("brains/mutant_bunnymanbrain")
...
local function fn()
    ...
    inst.AnimState:SetBuild("manrabbit_mutant_build")
    ...
    inst:SetBrain(brain)
    inst:SetStateGraph("SGmutantbunnyman")
...
return Prefab("mutant_bunnyman", fn, assets, prefabs)
