local assets =
{
    ...
    Asset("ANIM", "anim/reingoat_build.zip"),
...
SetSharedLootTable( 'chargedreingoat',
{
    {'meat',              1.00},
    {'meat',              1.00},
    {'goatmilk',          1.00},  
...
local function discharge(inst)
    ...
    inst.components.lootdropper:SetChanceLootTable('reingoat') 
...
local function setcharged(inst, instant)
    inst:AddTag("charged")
    inst.components.lootdropper:SetChanceLootTable('chargedreingoat')
...
local function fn()
    ...
    inst.AnimState:SetBuild("reingoat_build")
    inst.AnimState:PlayAnimation("idle_loop", true)
    inst.AnimState:Hide("fx")

    ------------------------------------------

    inst:AddTag("reingoat")
    inst:AddTag("animal")
    ...
    inst.components.herdmember:SetHerdPrefab("reingoatherd")
...
return Prefab("reingoat", fn, assets, prefabs)
