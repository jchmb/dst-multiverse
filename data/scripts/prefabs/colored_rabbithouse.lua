...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
    ...
    inst.components.spawner:Configure("colored_bunnyman", TUNING.TOTAL_DAY_TIME)
...
return Prefab("colored_rabbithouse", fn, assets, prefabs),
    MakePlacer("colored_rabbithouse_placer", "rabbithouse", "rabbit_house", "idle")
