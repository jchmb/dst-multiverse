local assets =
{
	...
	Asset("ANIM", "anim/bunnyman_snow_build.zip"),
...
local function fn()
	...
	inst.AnimState:SetBuild("bunnyman_snow_build")
	...
	inst.AnimState:SetClientsideBuildOverride("insane", "bunnyman_snow_build", "manrabbit_beard_build")
...
return Prefab("bunnyman_snow", fn, assets, prefabs)
