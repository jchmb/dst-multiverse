...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
    ...
    inst.components.spawner:Configure("bunnyman_snow", TUNING.TOTAL_DAY_TIME)
...
return Prefab("rabbithouse_snow", fn, assets, prefabs),
    MakePlacer("rabbithouse_snow_placer", "rabbithouse", "rabbit_house", "idle")
