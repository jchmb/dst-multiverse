local assets =
{
    ...
    Asset("ANIM", "anim/hound_base_slimey.zip"),
...
local function OnIsSummer(inst, issummer)
    inst.components.childspawner:SetRareChild("hound_slimey", issummer and 0.2 or 0)
end
...
local function fn()
    ...
    inst.components.childspawner.childname = "hound_slimey"
...
return Prefab("houndmound_slimey", fn, assets, prefabs)
