...
local assets =
{
    ...
    Asset("ANIM", "anim/rabbit_mutant_house.zip"),
...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
    ...
    inst.AnimState:SetBuild("rabbit_mutant_house")
    ...
    inst.components.spawner:Configure("mutant_bunnyman", TUNING.TOTAL_DAY_TIME)
