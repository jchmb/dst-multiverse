...
local function common_postinit(inst)
    ...
    inst.WaveComponent:SetWaveTexture(resolvefilepath("images/wave.tex"))
...
return MakeWorld("forest_slimey", prefabs, assets, common_postinit, master_postinit, {"forest_slimey"})
