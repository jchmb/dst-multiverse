    ...
    return FindEntity(
        ...
        function(guy)
            return ((guy.LightWatcher == nil or guy.LightWatcher:IsInLight())
                ...
                and (guy:HasTag("monster") or IsAnnoyed(inst))
        end,
...
local function SetNormalPig(inst)
    ...
    inst.components.lootdropper:AddChanceLoot("wildbore_house_blueprint", 0.2)
...
local function SetWerePig(inst)
    ...
    inst.components.lootdropper:AddChanceLoot("wildbore_house_blueprint", 0.20)
