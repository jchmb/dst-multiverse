local assets =
{
    Asset("ANIM", "anim/pig_king_fire.zip"),
...
local function fn()
    ...
    inst:AddTag("king")
    inst.AnimState:SetBank("Pig_King_Fire")
    inst.AnimState:SetBuild("Pig_King_Fire")
...
return Prefab("pigking_fire", fn, assets, prefabs)
