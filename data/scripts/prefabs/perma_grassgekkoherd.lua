...
local function fn()
    ...
    inst.components.herd:SetMemberTag("perma_grassgekko")
...
--[[
    ...
    inst.components.periodicspawner:SetPrefab("perma_grassgekko")
...
return Prefab("perma_grassgekkoherd", fn, nil, prefabs)
