...
local function SoundPath(inst, event)
    ...
    if inst.prefab == "spider_metal" and (event == "hit_response" or event == "die") then
        creature = "knight"
        event = event == "die" and "death" or "hurt"
    else
        if inst:HasTag("spider_warrior") then
...
return StateGraph("mw_spider", states, events, "idle", actionhandlers)
